<script setup>
    ...
    {
        viewer {
            repositories(first:11, orderBy:{field:CREATED_AT,direction: DESC}) {
                totalCount
                nodes {
                    id
                    name
...
<template>
    ...
    <section class="grid grid-cols-2 gap-10">
        <div v-for="project in data?.viewer.repositories.nodes" :key="project.id" class="p-8 border-4 my-4 rounded-lg hover:bg-gray-50">
